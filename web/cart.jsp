    ...
    <div class="table wrapper">
        ...
        <c:forEach items="${carts}" var="cart">
            <div class="th">
                <div class="pro clearfix">
                    <label class="fl">
                        <input class="checkBox" type="checkbox" value="${cart.id}" ${cart.isCheck == 1 ? "checked" : ""}/>
                        <span></span>
                    </label>
                    <a class="fl" href="#">
                        <dl class="clearfix">
                            <dt class="fl"><img src="img/imgs/${cart.goods.imgs[0]}" style="width: 120px; height: 120px;"></dt>
                            <dd class="fl">
                                <p style="display:inline-block;width: 144px;overflow: hidden;text-overflow: ellipsis;white-space:nowrap;">${cart.goods.name}</p>
                                    <%--                                <p>颜色分类:</p>--%>
                                    <%--                                <p>白色瓷瓶+白色串枚</p>--%>
                            </dd>
                        </dl>
                ...
                <div class="number">
                    <p class="num clearfix">
                        ...
                        <span class="fl" id="num">${cart.cartNum}</span>
                        <img class="fl add" src="img/temp/add.jpg">
                    </p>
                </div>
                <div class="price sAll">￥${cart.goods.price * cart.cartNum}</div>
                <div class="price">
                    <a class="del" style="cursor: pointer">删除</a>
                </div>
                    <%--                <div id="cartid" style="d">${cart.id}</div>--%>
                <input id="cartid" value="${cart.id}" hidden>
                <input id="goodsid" value="${cart.goods.id}" hidden>
            </div>
        </c:forEach>
        ...
        <div class="tr clearfix">
            ...
            <p class="fr">
                ...
                <a style="cursor: pointer" class="count">结算</a>
            </p>
        </div>
    </div>
</div>
    ...
    <div class="proCon clearfix">
        ...
        <div class="fl">
            <div class="proIntro change"><p>颜色分类</p>
                <div class="smallImg clearfix"><p class="fl on"><img src="img/temp/prosmall01.jpg" alt="白瓷花瓶+20支KL花"
                    ...
                    <p class="fl"><img src="img/temp/prosmall03.jpg" alt="20支KL花" data-src="img/temp/proBig03.jpg"></p>
...
<script type="text/javascript">
    ...
    //     console.log(document.getElementsByClassName("checkBox"))
        ...
        for (let i = 0; i < obj.length; i++) {
            if(obj[i].hasAttribute("checked")){
                $(".count").css("background", "#c10000")
                n = $(obj[i]).parent().parent().next().next().find("span").text()*1
                console.log(n)
                num += n
                console.log("num："+num)
                let p = $(obj[i]).parent().parent().next().text()
                price += p.split("￥")[1]*1*n
            }
        }
        if (num != 0){
            $("#sl").text(num)
            $("#all").text('￥'+price.toFixed(2))
        }
    })
</script>
</body>
